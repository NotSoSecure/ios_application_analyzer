...
class Ui_MainWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.txtPassword.setText(_translate("MainWindow", "alpine"))
        ...
        self.lblBundleVersion.setText(_translate("MainWindow", "N/A"))
        self.lblDataUUID.setText(_translate("MainWindow", "N/A"))
        self.lblMinimumOS.setText(_translate("MainWindow", "N/A"))
        self.lblPlatformVersion.setText(_translate("MainWindow", "N/A"))
        self.lblBundleUUID.setText(_translate("MainWindow", "N/A"))
        self.lblBundleName.setText(_translate("MainWindow", "N/A"))
        self.lblBundleID.setText(_translate("MainWindow", "N/A"))
        self.lblLocalPath.setText(_translate("MainWindow", "Local Path"))
        self.btnMobSF.setText(_translate("MainWindow", "MobSF"))
        self.btnReSnapShot.setText(_translate("MainWindow", "Latest Code"))
        ...
        self.InitializeControl(MainWindow)

    def InitializeControl(self, MainWindow):
        MainWindow.setWindowTitle("iOS Application Analyzer")
        self.txtIPAddress.setInputMask("000.000.000.000;_");
        #self.txtIPAddress.setText("192.168.1.1")
